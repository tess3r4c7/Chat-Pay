...
A full-stack digital payments platform with wallet management, P2P transfers, and transaction analytics.
...
# 4. Start frontend
# Create frontend/.env.local with NEXT_PUBLIC_USER_BACKEND_URL=http://localhost:3001
...
- [ ] E2E encrypted chat (NaCl/TweetNaCl)
